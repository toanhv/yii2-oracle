...
```php
use apaoww\AdminOci8\components\MenuHelper;
...
Return of `apaoww\AdminOci8\components\MenuHelper::getAssignedMenu()` has default format like:
...
return format of `apaoww\AdminOci8\components\MenuHelper::getAssignedMenu()` by provide a callback to this methode.
...
Using Sparated Menu
-------------------
Second parameter of `apaoww\AdminOci8\components\MenuHelper::getAssignedMenu()` used to get menu on it's own hierarchy.
