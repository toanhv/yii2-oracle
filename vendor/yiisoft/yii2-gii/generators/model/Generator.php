...
class Generator extends \yii\gii\Generator {
    ...
    public function generate() {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $files[] = new CodeFile(
                    Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/db/' . $className . 'DB.php', $this->render('model.php', $params)
            );
            $files[] = new CodeFile(
                    Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/' . $className . 'Base.php', $this->render('base.php', $params)
            );
            $files[] = new CodeFile(
                    _APP_PATH_ . '/../models/' . $className . '.php', $this->render('backend.php', $params)
            );
            $files[] = new CodeFile(
                    _APP_PATH_ . '/../../frontend/models/' . $className . '.php', $this->render('frontend.php', $params)
            );
            $files[] = new CodeFile(
                    _APP_PATH_ . '/../../wap/models/' . $className . '.php', $this->render('wap.php', $params)
            );
            $files[] = new CodeFile(
                    _APP_PATH_ . '/../../api/models/' . $className . '.php', $this->render('api.php', $params)
            );
        }
